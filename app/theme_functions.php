...
function dashboard_menu(){
    ...
    if ($user->isInstructor()) {
        ...
        if ($pendingDiscussionCount){
            $pendingDiscusionBadge = "<span class='badge badge-warning float-left'> {$pendingDiscussionCount} </span>";
        }
    ...
    if ($user->isInstructor()) {
        $menu = $menu + apply_filters('dashboard_menu_for_instructor', [
            'earning' => [
                'name' => __t('earnings'),
