                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="course-filter-wrap">
                            ...
                            <div class="course-filter-form-group box-shadow p-3 mb-4">
                                <div class="form-group">
                                    <h4 class="mb-3">{{__t('single_course_level')}}</h4>
                            ...
                            <div class="course-filter-form-group box-shadow p-3 mb-4">
                                <div class="form-group">
                                    ...
                                    <div class="filter-form-by-rating-field-wrap">
                                        <label class="d-flex">
                                            <input type="radio" name="rating" value="4.5" class="ml-2" {{checked('4.5', request('rating'))}} >
                                            {!! star_rating_generator(4.5) !!}
                                            <span class="ml-2">4.5 فأكثر</span>
                                        </label>
                                        <label class="d-flex">
                                            <input type="radio" name="rating" value="4" class="ml-2" {{checked('4', request('rating'))}}>
                                            {!! star_rating_generator(4) !!}
                                            <span class="ml-2">4.0 فأكثر</span>
                                        </label>
                                        <label class="d-flex">
                                            <input type="radio" name="rating" value="3" class="ml-2" {{checked('3', request('rating'))}}>
                                            {!! star_rating_generator(3) !!}
                                            <span class="ml-2">3.0 فأكثر</span>
                                        </label>
                                        <label class="d-flex">
                                            <input type="radio" name="rating" value="2" class="ml-2" {{checked('2', request('rating'))}}>
                                            {!! star_rating_generator(2) !!}
                                            <span class="ml-2">2.0 فأكثر</span>
                                        </label>
                                        <label class="d-flex">
                                            <input type="radio" name="rating" value="1" class="ml-2" {{checked('1', request('rating'))}}>
                                            {!! star_rating_generator(1) !!}
                                            <span class="ml-2">1.0 و أكثر</span>
                                        </label>
                        ...
                        <div class="course-sorting-form-wrap form-inline mb-4">
                            ...
                            <div class="form-group mr-2">
                                <button type="button" id="hide-course-filter-sidebar" class="btn btn-outline-dark">
                                    <i class="la la-filter"></i> فلترة  {{count(array_except(array_filter(request()->input()), 'q'))}}
                                </button>
                            </div>

                            <div class="form-group mr-2">
                                <label class="filter-col mr-2">إظهار:</label>
                            ...
                            <div class="form-group">
                                <select class="form-control mr-2" name="sort">
                                    <option value="relevance" {{selected('relevance', request('sort'))}}>الأكثر صلة</option>
                                    <option value="most-reviewed" {{selected('most-reviewed', request('sort'))}}>الأكثر مراجعة</option>
                                    <option value="highest-rated" {{selected('highest-rated', request('sort'))}}>الأكثر تقييماً</option>
                                    <option value="newest" {{selected('newest', request('sort'))}}>الأحدث</option>
                                    <option value="price-low-to-high" {{selected('price-low-to-high', request('sort'))}}>أقل سعر</option>
                                    <option value="price-high-to-low" {{selected('price-high-to-low', request('sort'))}}>أعلى سعر</option>
                                </select>
                            </div>


                            <div class="form-group ml-auto">
                                <a href="{{route('courses')}}" class="btn btn-link"> <i class="la la-refresh"></i> مسح بيانات الفلترة </a>
                            </div>
                        </div>


                        @if($courses->count())
                            <p class="text-muted mb-3"> إظهار {{$courses->count()}} نتيجة من  {{$courses->total()}} لبحثك </p>
