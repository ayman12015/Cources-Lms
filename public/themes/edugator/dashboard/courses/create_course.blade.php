        ...
        <div class="card-body">
            ...
            <form method="post">
                ...
                <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                    <label for="title">{{__t('course_name')}}</label>
                    <div class="input-group mb-3">
                        <input type="text" name="title" class="form-control" id="title" placeholder="" value="{{old('title')}}" data-maxlength="120" >
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <textarea name="short_description" id="short_description" class="form-control" placeholder="" data-maxlength="220"></textarea>
                        <div class="input-group-append">
                ...
                <button type="submit" class="btn btn-warning"> <i class="la la-save"></i> {{__t('save')}}</button>
            </form>
