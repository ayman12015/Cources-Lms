...
@section('content')
    ...
    <div class="curriculum-top-nav d-flex  mb-5 p-2">
                ...
                @foreach($course->sections as $section)
                    <div id="dashboard-section-{{$section->id}}" class="dashboard-course-section bg-white border mb-4">
                        ...
                        <div class="section-add-item-wrap p-3">
                            ...
                            <a href="javascript:;" class="new-assignment-btn mr-3"> <i class="la la-plus-square"></i> {{__t('single_assignment')}}</a>
                        </div>
                    </div>
                @endforeach
            </div>
                ...
                <div class="section-item-form-html  p-4 border">
                    ...
                    <form class="curriculum-lecture-form" action="{{route('new_lecture', $course->id)}}" method="post">
                        ...
                        <div class="form-group d-flex">
                            <span class="ml-5">{{__t('free_preview')}}</span>
                            <label class="switch">
                        ...
                        <div class="form-group text-right">
                            ...
                            <button type="submit" class="btn btn-info btn-add-lecture"  name="save" value="save_next"> <i class="la la-save"></i> {{__t('add_lecture_btn')}}</button>
                        </div>
                    </form>
                </div>
            </div>
