                ...
                <div class="question-wrap">
                    ...
                    <form action="{{route('quiz_attempt_url', $quiz->id)}}" method="post" class="quiz-question-submit">
                        ...
                        <button type="submit" name="question-submit-btn" class="btn btn-dark-blue btn-lg question-submit-btn">
                            ...
                            @else
                                التالي <i class="la la-angle-left"></i>
                            @endif
                        </button>
        ...
        <div class="modal-dialog modal-alert">
            <div class="modal-content">
                <div class="modal-body text-center">
                    <h4>لا يمكنك تخطي السؤال دون الإجابة عليه</h4>
                    <p>{{$question->title}}</p>
                    <button type="button" class="btn btn-info btn-wide" data-dismiss="modal">موافق</button>
                </div>
            </div>
        </div>
    </div>
