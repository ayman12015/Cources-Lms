            ...
            <form action="{{route('save_settings')}}" method="post"> @csrf
                ...
                <div class="form-group row {{ $errors->has('email_address')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        ...
                        <p style="display:none;" class="text-info"> @lang('admin.email_address_help_text')</p>
                    </div>
                </div>
                ...
                <div class="form-group row {{ $errors->has('date_format')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        ...
                        <p style="display:none;" class="text-info"> @lang('admin.date_format_help_text')</p>
                    </div>
                </div>
                ...
                <div class="form-group row {{ $errors->has('time_format')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        ...
                        <p><a style="display:none;" href="http://php.net/manual/en/function.date.php" target="_blank">@lang('admin.date_time_read_more')</a> </p>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-offset-4 col-sm-8">
                        <button type="submit" id="settings_save_btn" class="btn btn-primary">@lang('admin.save')</button>
                    </div>
                </div>
