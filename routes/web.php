...
Route::group(['middleware' => ['auth'] ], function() {
    ...
    Route::group(['prefix' => 'checkout' ], function() {
        ...
        Route::post('paytabs', 'GatewayController@paytabsRedirect')->name('paytabs_redirect');
...
Route::group(['prefix'=>'admin', 'middleware' => ['auth', 'admin'] ], function() {
	...
	/** added **/
	Route::get('/homepage', 'HomePageController@index')->name('home_page');
	Route::post('/homepage', 'HomePageController@update')->name('edit_home_page');
	
	Route::get('/partner', 'PartnerController@index')->name('partner');
    Route::get('/new_partner', 'PartnerController@create')->name('create_partner');
    Route::post('/new_partner', 'PartnerController@store')->name('save_partner');
	Route::get('remove_partner/{id}', 'PartnerController@destroy' )->name('remove_partner');
	Route::get('edit_partner/{id}', 'PartnerController@edit' )->name('edit_partner');
	Route::post('edit_partner/{id}', 'PartnerController@update' )->name('update_partner');
